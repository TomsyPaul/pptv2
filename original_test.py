...
if  __name__ == "__main__":
    ...
    bytes_sent1 = len(tensor_to_send)
    bytes_sent2 = len(serialized_cipherx)
    #bytes_sent += tensor_to_send.nelement() * tensor_to_send.element_size()
    print("In 0.. Sent..x=",x,"\nCipherx=",cipherx,"\nBytes Sent1..",bytes_sent1,"\nBytes Sent2..",bytes_sent2)
    ...
    #received_tensor=copy.deepcopy(tensor_to_send)
